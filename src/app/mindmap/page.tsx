    ...
    return (
        <div className="h-[100dvh] bg-[#0f172a] text-white flex flex-col items-center overflow-hidden font-sans">
            ...
            <header className="shrink-0 pt-3 pb-1 text-center">
                <h1 className="text-2xl md:text-3xl font-black bg-gradient-to-r from-red-400 to-rose-600 bg-clip-text text-transparent inline-block">
                    🔥 실시간 커뮤니티 트렌드
                </h1>
            </header>
            ...
            {loading ? (
                ...
                <div className="flex-1 min-h-0 w-full relative">
                    <div
                        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#1e293b] rounded-3xl shadow-2xl border border-[#334155] overflow-hidden"
                        style={{ width: 'min(calc(100vw - 16px), calc(100dvh - 90px))', aspectRatio: '1' }}
                    >
