...
export default function MindmapPage() {
    ...
    return (
        <div style={{ position: 'fixed', inset: 0, background: '#0f172a', overflow: 'hidden', fontFamily: 'sans-serif', color: 'white' }}>
            ...
            {loading ? (
                ...
                <div style={{
                    position: 'absolute',
                    top: `calc(50% + ${HEADER_H / 2}px)`,
                    left: '50%',
                    transform: 'translate(-50%, -50%)',
                    width: `min(calc(100vw - 16px), calc(100dvh - ${HEADER_H + 16}px))`,
                    aspectRatio: '1',
                    background: '#1e293b',
                    borderRadius: '1.5rem',
