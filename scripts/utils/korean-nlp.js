...
const STOPWORDS = new Set([
    ...
    // --- 추가: 쇼핑/ IT기기 커뮤니티 노이즈 ---
    '가격', '구매', '추천', '질문', '할인', '특가', '배송', '무배', '무료배송', '로켓배송', 
    '얼마', '원', '만', '천', '개', '개입', '어디서', '파나요', '있나요', '가성비', 
    '써보신분', '어떤가요', '비교', '품절', '재고', '득템', '후기', '도움', '알려주세요', 
    '조언', '선택', '결정', '궁금', '살까', '말까', '살까요', '탑승', '역대가', '체감가', 
    '어떤지', '괜찮은가요', '어떨까요', '도와주세요', '부탁드립니다', '찾습니다', '필요해요', 
    '사고', '샀는데', '있을까요', '세일', '사봅니다', '사봤습니다', '샀습니다', '결제',
    '취소', '환불', '반품', '교환', '배송비', '쿠폰', '적립', '포인트', '이벤트', '당첨',
    '네이버페이', '카카오페이', '토스', '스마일페이', '쇼핑라이브', '방송', '예약', '출고'
]);
...
const DICTIONARY = new Set([
    ...
    // --- 추가: IT/가전/쇼핑 고유 명사 (절대 분리되면 안 되는 단어들) ---
